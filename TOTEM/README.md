<!-- [![<picture align="center">
  <source media="(prefers-color-scheme: dark)" srcset="/TOTEM/docs/images/TOTEM_logo_dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="/TOTEM/docs/images/TOTEM_logo_bright.svg">
  <img alt="TOTEM logo" src="/TOTEM/docs/images/TOTEM_logo_dark.svg">
</picture>
...
![TOTEM layout](/TOTEM/docs/images/TOTEM_layout.svg)

***

## PCB

[Here](/TOTEM/PCB/) you can find the KiCad files and Gerbers for the TOTEM.
...
You can use the TOTEM without a case, but [here](/TOTEM/case/) you can find one I made for it.

***

## BUILD GUIDE

The build guide for the TOTEM can be found [here](/TOTEM/docs/buildguide.md).

***

## FIRMWARE

[QMK (VIAL) precompiled](/TOTEM/firmware/QMK/) or [QMK (VIAL) source](/TOTEM/firmware/QMK/VIAL_source/) for the TOTEM (wired using the XIAO RP2040)\
[ZMK precompiled](/TOTEM/firmware/ZMK/) or [ZMK source (outdated)](https://github.com/GEIGEIGEIST/zmk-config-totem) for the TOTEM (wireless using the XIAO BLE)
...
![TOTEM black resin](/TOTEM/docs/images/TOTEM_black_perspective.jpg)\
![TOTEM black resin](/TOTEM/docs/images/TOTEM_black_top.jpg)\
![TOTEM black resin](/TOTEM/docs/images/TOTEM_black_bottom.jpg)

This is the TOTEM with a black resin tenting bottom plate

![TOTEM black resin tenting](/TOTEM![](<picture align="center">
  <source media="(prefers-color-scheme: dark)" srcset="../docs/images/TOTEM_logo_dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="../docs/images/TOTEM_logo_bright.svg">
  <img alt="TOTEM logo" src="../docs/images/TOTEM_logo_dark.svg">
</picture>
...
If you build a TOTEM I would be pretty happy to see some pictures. And if you want to leave me a tip you can do this [here](https://ko-fi.com/geigeigeist) (but please don't feel pressured)
)/docs/images/TOTEM_black_tenting_example.jpg)\
[Video by *Wolfgang's Channel* showing the tenting system in action](https://youtu.be/rvM2BthjEI4?si=mTJVdPeZstshnDyo)
